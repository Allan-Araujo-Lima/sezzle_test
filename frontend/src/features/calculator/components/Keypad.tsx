...
export function Keypad(props: KeypadProps) {
    return (
        <div className="calculator-keypad">
            ...
            <Button variant="operation" isActive={props.activeOperation === 'divide'} onClick={() => props.chooseOperation('divide')}>÷</Button>
            ...
            <Button variant="operation" isActive={props.activeOperation === 'multiply'} onClick={() => props.chooseOperation('multiply')}>×</Button>
            ...
            <Button variant="operation" isActive={props.activeOperation === 'subtract'} onClick={() => props.chooseOperation('subtract')}>−</Button>
            ...
            <Button variant="operation" isActive={props.activeOperation === 'add'} onClick={() => props.chooseOperation('add')}>+</Button>
